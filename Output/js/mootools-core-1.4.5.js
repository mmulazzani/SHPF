...
web build:
 - http://mootools.net/core/a2834c28ab499b8bf239a9fd7c4a5815

packager build:
 - packager build Core/Array Core/Function Core/Object Core/Event Core/Browser Core/Class Core/Element Core/Request Core/Request.JSON Core/JSON Core/DOMReady
...
},get:function(){return this.id||null;},erase:function(){this.id=this.getAttributeNode("id").value="";}};}})();(function(){this.Chain=new Class({$chain:[],chain:function(){this.$chain.append(Array.flatten(arguments));
...
}else{this.onSuccess(b,c);}}});(function(){Element.Properties.events={set:function(b){this.addEvents(b);}};[Element,Window,Document].invoke("implement",{addEvent:function(f,h){var i=this.retrieve("events",{});
